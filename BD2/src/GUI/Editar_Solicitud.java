 ...
 * @author Ana
 */
public class Editar_Solicitud extends javax.swing.JInternalFrame {
    ...
    public Editar_Solicitud(String Archivo) {
        initComponents();
        ...
        objetos = new Vector<>();
        //info = new Empresa().agregarOferta("", "");
    ...
    private void guardarCambios(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_guardarCambios
        if(!tablaSel.isEditing() && 
           JOptionPane.showConfirmDialog(this, "¿Desea guardar los cambios?", "Guardar", JOptionPane.YES_NO_CANCEL_OPTION) == 0){
            ...
            //new Biblioteca().guardar(registro, archivo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_Solicitud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Editar_Solicitud dialog = new Editar_Solicitud(null);
